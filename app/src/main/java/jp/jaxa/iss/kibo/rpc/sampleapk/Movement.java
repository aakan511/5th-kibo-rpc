...
public final class Movement {
    ...
    public static Path[] scanningPaths = {
            ...
            new Path(new Quaternion(0f, 0.707f, 0f, 0.707f), new Point(10.925d, -9.2d, 5.19d), new Point(10.925, -8.875, 4.45)),
            new Path(new Quaternion(0f, 0.707f, 0f, 0.707f), new Point(10.925d, -7.99, 4.45)), //y=-7.925
